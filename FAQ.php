...
<body>
    <main>
        ...
        <h1 class="faq-heading">How to use Utopia</h1>
        <section class="faq-container">
            <div class="faq-one">
                ...
                <div class="faq-body">
                    ...
                    <br><b>Step 3</b> Click the Share button to post to your profile.</p>
                </div>
            </div>
            <hr class="hr-line">
            <div class="faq-two">
            ...
            <div class="faq-three">
                ...
                <div class="faq-body">
                    ...
                    <br>Comments on the posts will also be deleted in the same way.</p>
                </div>
            </div>
            <div class="faq-four">
